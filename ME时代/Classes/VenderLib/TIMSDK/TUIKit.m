...
//    TIMFriendProfileOption *newpo = [TIMFriendProfileOption new];
//    newpo.friendFlags =TIM_PROFILE_FLAG_NICK|TIM_PROFILE_FLAG_FACE_URL;
//    userConfig.friendProfileOpt = newpo;
//    NSLog(@"%@",[userConfig.friendProfileOpt mj_keyValues]);
