...
{
    [super viewDidLoad];
    self.tableView.contentInset = UIEdgeInsetsMake(kMeNavBarHeight, 0, 0, 0);
    [self setupViews];
}
...
{
    if(scrollView.contentOffset.y <= (TMessageController_Header_Height + kMeNavBarHeight)){
        [self loadMessage];
    }
}
