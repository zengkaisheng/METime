...
- (void)setNormalImage:(UIImage *)normalImage{
    _normalImage = [MEStarButton reSizeImage:normalImage toSize:self.frame.size];
    [self setImage:_normalImage forState:UIControlStateNormal];
    
}

- (void)setHighlightedImage:(UIImage *)highlightedImage{
    _highlightedImage = [MEStarButton reSizeImage:highlightedImage toSize:self.frame.size];
...
- (void)setFractionPart:(CGFloat)fractionPart{
    ...
    UIImage *image = [MEStarButton croppedImage:self.highlightedImage fraction:fractionPart];
