...
#ifdef TestVersion
    NSString *shareIP = [NSString stringWithFormat:@"https://develop.meshidai.com/meAuth.html?entrance=start&bank_id=%@&uid=%@",kMeUnNilStr(model.idField),kMeUnNilStr(kCurrentUser.uid)];
#else
      NSString *shareIP = [NSString stringWithFormat:@"https://msd.meshidai.com/meAuth.html?entrance=start&bank_id=%@&uid=%@",kMeUnNilStr(model.idField),kMeUnNilStr(kCurrentUser.uid)];
#endif
