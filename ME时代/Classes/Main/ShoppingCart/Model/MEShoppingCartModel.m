...
//}
//
//- (void)setGoods:(NSMutableArray<MEGoodsModel *> *)goods {
//    _goods = goods;
//    NSMutableArray *tempArray = [NSMutableArray new];
//    for (NSDictionary *dic in goods) {
//        MEGoodsModel *model = [[MEGoodsModel alloc] init];
...
@implementation MEShoppingCartModel
