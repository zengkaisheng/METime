...
//    MEShareTool *shareTool = [MEShareTool me_instanceForTarget:self];
    ...
    NSString *shareUrl = [NSString stringWithFormat:@"%@assemble/newAuth.html?id=%@&inviteCode=%@",baseUrl,self.model.order_sn,kMeUnNilStr(kCurrentUser.invitation_code).length>0?kMeUnNilStr(kCurrentUser.invitation_code):@""];
