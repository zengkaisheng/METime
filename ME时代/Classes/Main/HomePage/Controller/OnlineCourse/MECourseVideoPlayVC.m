...
- (void)orientationHandler {
    if ([UIDevice currentDevice].orientation == UIDeviceOrientationLandscapeLeft || [UIDevice currentDevice].orientation == UIDeviceOrientationLandscapeRight) {
        ...
        self.tableView.frame = CGRectMake(0, CGRectGetMaxY(self.playerView.frame), SCREEN_WIDTH, SCREEN_HEIGHT-CGRectGetMaxY(self.playerView.frame)-50);
    }
}
...
- (UITableView *)tableView{
    if(!_tableView){
        _tableView = [[UITableView alloc]initWithFrame:CGRectMake(0, CGRectGetMaxY(self.playerView.frame), SCREEN_WIDTH, SCREEN_HEIGHT-CGRectGetMaxY(_playerView.frame)-50) style:UITableViewStylePlain];
...
- (XMPlayerView *)playerView {
    if (!_playerView) {
        ...
        _playerView.frame = CGRectMake(0, 20, palyerW, 210*kMeFrameScaleY());
...
- (UIView *)bottomView {
    if (!_bottomView) {
        _bottomView = [[UIView alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(self.tableView.frame), SCREEN_WIDTH, 50)];
