...
- (void)toShare{
    ...
    shareTool.sharWebpageUrl = [NSString stringWithFormat:@"%@%@&inviteCode=%@",MEIPArticelShare,@(_detailModel.article_id).description,[kMeUnNilStr(kCurrentUser.invitation_code) length]>0?kMeUnNilStr(kCurrentUser.invitation_code):@" "];
