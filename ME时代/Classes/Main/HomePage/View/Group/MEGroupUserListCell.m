...
@implementation MEGroupUserListCell
...
- (void)setUIWithModel:(MEGroupUserContentModel *)model{
    ...
    _countLbl.text = [NSString stringWithFormat:@"还差%@人",kMeUnNilStr(model.num)];
